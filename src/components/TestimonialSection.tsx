      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <div className="relative pt-6 md:pt-8 pb-6 md:pb-8 pl-6 md:pl-8 pr-6 md:pr-8 mx-auto lg:mx-0 max-w-md w-full">
              ...
              <div className="relative z-10 overflow-hidden rounded-xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 text-white">
                  <p className="text-lg md:text-xl font-medium font-heading">"Law should enable growth, not limit it."</p>
                ...
                <div className="absolute bottom-[85px] md:bottom-[120px] left-0 bg-primary text-primary-foreground rounded-r-lg py-1 md:py-2 px-3 md:px-4 shadow-lg text-sm md:text-base">
                  Expert Advice
                </div>
              </div>
