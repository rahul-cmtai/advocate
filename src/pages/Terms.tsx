...
const Terms = () => (
  <>
    ...
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <p className="mb-4">Welcome to Advocate Gauri Saraswat. By accessing or using our website and legal services, you agree to the following terms and conditions. Please read them carefully before engaging with our firm for Family Law, Criminal Defense, Civil Litigation, Corporate Law, or any other legal services.</p>
      <h2 className="text-xl font-semibold mt-8 mb-2">Scope of Services</h2>
      <ul className="list-disc ml-6 mb-4">
        <li>We provide legal consultation, advice, and representation in areas including but not limited to Family Law, Criminal Defense, Civil Litigation, and Corporate Law.</li>
      ...
      <p className="mb-4">While we strive to provide the highest quality legal services, Advocate Gauri Saraswat is not liable for any damages arising from the use of this website or reliance on information provided herein. Legal outcomes depend on individual circumstances and cannot be guaranteed.</p>
      ...
      <p>For questions regarding these terms, please contact us at <a href="mailto:legal@gaurisaraswat.com" className="text-orange-accent underline">legal@gaurisaraswat.com</a>.</p>
    </div>
    <Footer />
  </>
);
