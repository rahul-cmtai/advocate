...
const Privacy = () => (
  <>
    ...
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <p className="mb-4">At Advocate Gauri Saraswat, we are committed to protecting your privacy and ensuring the confidentiality of your personal information. This Privacy Policy outlines how we collect, use, and safeguard your data when you engage with our legal services, including Family Law, Criminal Defense, Civil Litigation, and Corporate Law.</p>
      ...
      <p className="mb-4">You have the right to access, update, or request deletion of your personal information at any time. To exercise these rights or for any privacy-related questions, please contact us at <a href="mailto:legal@gaurisaraswat.com" className="text-orange-accent underline">legal@gaurisaraswat.com</a>.</p>
